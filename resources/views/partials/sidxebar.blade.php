            ...
            <div id="kt_aside_menu"
                ...
                @foreach(config('menu') as $menu)
                    ...
                    @foreach($menu['pages'] as $page)
                        @if(request()->url() == route($page['route_name']))
                            @php($menu['current'] = true && $cur_menu=$menu)
                            @break
                        @endif
                    @endforeach
                    ...
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                         ...
                         class="menu-item @if(isset($menu['current']))  active-menu  @endif    py-2">
                        ...
                        <div class="menu-sub menu-sub-dropdown px-2 py-4 w-250px mh-75 overflow-auto">
                            ...
                            @foreach($menu['pages'] as $page)
                                <div class="sidebar-menu-item menu-item">
                                    ...
                                    <a class="menu-link @if(request()->url() == route($page['route_name'])) active  @endif  "
            ...
            <div
                ...
                <div id="kt_app_sidebar_secondary_menu_wrapper" class="hover-scroll-y px-3 mx-3"
                    ...
                    <div class="menu-item">
                        ...
                        <div class="menu-content">
                            <span class="menu-section fs-5 fw-bolder ps-1 py-1">{{ $cur_menu['name'] }}</span>
                        </div>
