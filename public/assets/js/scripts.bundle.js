...
var KTAppSidebar = function () {
    ...
    return {
        init: function () {
            var n;
            (e = document.querySelector("#kt_app_header_menu"), t = document.querySelector("#kt_app_sidebar_menu_wrapper"), null !== e && null !== t) && (t && (n = menuWrapper.querySelector(".menu-link.active")) && !0 !== KTUtil.isVisibleInContainer(n, menuWrapper) && menuWrapper.scroll({
...
var insertDuree = function () {
    if($('#hoursSelector').val() == '' && $('#minuteSelector').val() == ''){
        $('#duree').val('00:00')
    }
    else if($('#hoursSelector').val() == ''){
        $('#duree').val('00' + ':' + $('#minuteSelector').val())
    }
    else if($('#minuteSelector').val() == ''){
        $('#duree').val($('#hoursSelector').val() + ':' + '00')
    }
    else{
        $('#duree').val($('#hoursSelector').val() + ':' + $('#minuteSelector').val())
    }
}

$('#hoursSelector').keyup(function(){
    insertDuree()
})

$('#minuteSelector').keyup(function(){
    insertDuree()
})
